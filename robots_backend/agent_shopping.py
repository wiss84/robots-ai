...
import time
from composio_tools_filtered import filtered_composio_google_search, filtered_composio_shopping_search
...
tools = [filtered_composio_google_search, filtered_composio_shopping_search]
